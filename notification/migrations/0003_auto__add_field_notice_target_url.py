...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notice.target_url'
        db.add_column(u'notification_notice', 'target_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notice.target_url'
        db.delete_column(u'notification_notice', 'target_url')
