...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NoticeType.state'
        db.add_column(u'notification_noticetype', 'state',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NoticeType.state'
        db.delete_column(u'notification_noticetype', 'state')
