...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NoticeType.past_tense'
        db.add_column(u'notification_noticetype', 'past_tense',
    ...
    def backwards(self, orm):
        # Deleting field 'NoticeType.past_tense'
        db.delete_column(u'notification_noticetype', 'past_tense')
