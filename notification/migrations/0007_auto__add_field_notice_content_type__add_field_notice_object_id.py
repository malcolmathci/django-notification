...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'notification_notice', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Notice.object_id'
        db.add_column(u'notification_notice', 'object_id',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'notification_notice', 'content_type_id')

        # Deleting field 'Notice.object_id'
        db.delete_column(u'notification_notice', 'object_id')
