...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'notification_notice', 'sender_id')


    def backwards(self, orm):
        # Adding field 'Notice.sender'
        db.add_column(u'notification_notice', 'sender',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'sent_notices', null=True, to=orm['auth.User']),
                      keep_default=False)
