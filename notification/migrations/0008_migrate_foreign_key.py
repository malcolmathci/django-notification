...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        content_type = orm['contenttypes.contenttype'].objects.get(model='user')
        for entry in orm.Notice.objects.all():
            entry.content_type = content_type
            entry.object_id = entry.sender.pk
            entry.save()
    ...
    complete_apps = ['notification', 'contenttypes', 'notification']
    symmetrical = True
